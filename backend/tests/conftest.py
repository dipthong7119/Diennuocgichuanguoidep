...
# LƯU Ý: sqlite:///:memory: tạo một DB RIÊNG BIỆT cho mỗi connection mới.
# TestClient (qua get_db override) và fixture db_session dùng 2 connection khác nhau,
# nên nếu không ép dùng chung 1 connection (StaticPool), bảng tạo ở db_session
# sẽ "vô hình" với các request đi qua TestClient → lỗi "no such table: NguoiDung".
